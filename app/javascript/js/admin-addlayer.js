...
$(document).ready(function() {
	...
	$("#labelWriteBtn").click(function(){
		...
		html += '<td class="its-td"><img src="../skin/default/images/common/icon_move.gif" style="cursor:pointer"> ['+labelTypeText+'] '+ windowLabelExp+' <span class="btn small gray"><button type="button" class="listJoinBtn" id="listJoinBtn" value="'+ user_layer_seq  +'" join_type="user" >수정</button></span></td>';			
		html += '<td class="its-td"><input type="checkbox" name="labelItem[user]['+ user_layer_seq  +'][use]" class="user_chUse" user_ch="'+user_layer_seq+'" value="Y" /> 사용</td>';
		html += '<td class="its-td"><input type="checkbox" name="labelItem[user]['+ user_layer_seq  +'][required]" class="user_chRequired" value="Y" /> 필수</td>';		
		...
		html += '<td class="its-td">'+ windowLabelName +'</td>';
		html += '<td class="its-td"><img src="../skin/default/images/common/icon_move.gif" style="cursor:pointer"> ['+labelTypeText+'] '+ windowLabelExp+' <span class="btn small gray"><button type="button" class="listJoinBtn" id="listJoinBtn" value="'+ order_layer_seq  +'" join_type="order" >수정</button></span></td>';		
		html += '<td class="its-td"><input type="checkbox" name="labelItem[order]['+ order_layer_seq +'][use]" class="order_chUse" order_ch="'+order_layer_seq+'" value="Y" /> 사용</td>';
		html += '<td class="its-td"><input type="checkbox" name="labelItem[order]['+ order_layer_seq +'][required]" class="order_chRequired" value="Y" /> 필수</td>';		
		html += '<td class="its-td">'+hiddenHtml+'<span class="btn-minus" onclick="deleteRow(this)"><button type="button"></button></span></td>';
		html += '</tr>';
		...
		$(".labelList_order").append(html);
			...
			if(windowJoinType =='user'){					
				...
				html += '<td class="its-td"><input type="checkbox" name="labelItem[user]['+ windowLabelSeq  +'][use]" class="user_chUse" user_ch="'+windowLabelSeq+'" value="Y" /> 사용</td>';
				html += '<td class="its-td"><input type="checkbox" name="labelItem[user]['+ windowLabelSeq  +'][required]" class="user_chRequired" value="Y" /> 필수</td>';		
				html += '<td class="its-td">'+hiddenHtml+'<span class="btn-minus" onclick="deleteRow(this)"><button type="button"></button></span></td>';
				html += '</tr>';
				...
				html = '<tr class="layer'+windowLabelSeq+'">';		
				html += '<td class="its-td">'+ windowLabelName +'</td>';
				html += '<td class="its-td"><img src="../skin/default/images/common/icon_move.gif" style="cursor:pointer"> ['+labelTypeText+'] '+ windowLabelExp+' <span class="btn small gray"><button type="button" class="listJoinBtn" id="listJoinBtn" value="'+ windowLabelSeq  +'" join_type="order" >수정</button></span></td>';
				//html += '<td class="its-td"><span class="listJoinBtn" value="'+ windowLabelSeq +'" join_type="order" style="cursor:pointer;">'+ windowLabelExp+' ('+labelTypeText+')</span></td>';
				html += '<td class="its-td"><input type="checkbox" name="labelItem[order]['+ windowLabelSeq +'][use]" class="order_chUse" order_ch="'+windowLabelSeq+'" value="Y" /> 사용</td>';
				html += '<td class="its-td"><input type="checkbox" name="labelItem[order]['+ windowLabelSeq +'][required]" class="order_chRequired" value="Y" /> 필수</td>';		
				html += '<td class="its-td">'+hiddenHtml+'<span class="btn-minus" onclick="deleteRow(this)"><button type="button"></button></span></td>';
				html += '</tr>';
...
{
	openDialog("가입항목 추가","joinDiv",{"width":"800","height":"500"});
	...
	switch(type)
	{
		...
		case "checkbox" :
			...
			if (right) {
				...
				html += '<input type="checkbox" name="labelKey[]" class="null"> <input type="text" name="windowLabelValue[]" size="30" style="height:18px;" class="line"> <button type="button" value="-" class="pointer" onclick="deleteRow(this)"><img src="/admin/skin/default/images/design/icon_design_minus.gif" height="18px" align="middle"></button>';
			}
			html += '</td>';
			html += '</tr>';
		break;
		...
		case "select" :
			...
			if (right) {
				...
				html += '<tr class="labelAdd"><th align="left" style="width:65px;"></th>';
				html += '<td>';
				html += '<input type="text" name="windowLabelRight['+label_item_seq+']" id="selectRight" class="line" size="30" style="height:18px;"> <button type="button" value="-" class="pointer" onclick="deleteRow(this)"><img src="/admin/skin/default/images/design/icon_design_minus.gif" height="18px" align="middle"></button><button type="button" value="+" class="pointer" onclick="labelSubAdd('+label_item_seq+')"><img src="/admin/skin/default/images/common/icon_plus.gif" height="18px" align="middle"></button>';
				html += '</td>';
				html += '</tr>';
			}
			else {
				html += '<input type="text" name="windowLabelValue['+label_item_seq+']" class="windowLabelValue line" label_item_seq="'+label_item_seq+'" size="30" style="height:18px;" > <button type="button" value="-" class="pointer" onclick="deleteRow(this)"><img src="/admin/skin/default/images/design/icon_design_minus.gif" height="18px" align="middle"></button> <button type="button" value="+" class="pointer" onclick="labelSubAdd('+label_item_seq+')"><img src="/admin/skin/default/images/common/icon_plus.gif" height="18px" align="middle"></button>';
			}
			html += '</td>';
			html += '</tr>';
			...
			{							
				...
				if (subcount > 1)
				{
					...
					{	
						...
						labelTableHtml += '→ <input type="text" name="windowSubLabelValue['+label_item_seq+'][]" value="'+ labelsubValue[0][j] +'" size="30" style="height:18px;" class="line"> <button type="button" value="-" class="pointer" onclick="deleteRow(this)"><img src="/admin/skin/default/images/common/icon_minus.gif" height="18px" align="middle"></button>';
				...
				if (count > 1)
				{
					for (i=1; i<count; i++)
					{
						...
						labelTableHtml += '<tr class="labelAdd"><td></td>';
						labelTableHtml += '<td>';
						labelTableHtml += '<input type="text" name="windowLabelvalue['+label_item_seq+']" label_item_seq="'+label_item_seq+'" value="'+ labelsubValue[i][0] +'" size="30" style="height:18px;" class="windowLabelValue line"> <button type="button" class="pointer" onclick="deleteRow(this)"><img src="/admin/skin/default/images/design/icon_design_minus.gif" height="18px" align="middle"></button> <button type="button" class="pointer" onclick="labelSubAdd('+label_item_seq+')"><img src="/admin/skin/default/images/common/icon_plus.gif" height="18px" align="middle"></button>';
						labelTableHtml += '</td>';
						labelTableHtml += '</tr>';
						...
						if (subcount > 1)
						{
							...
							{	
								labelTableHtml += '<tr class="labelAdd"><td></td><td>';
								labelTableHtml += '→ <input type="text" name="windowSubLabelValue['+label_item_seq+'][]" value="'+ labelsubValue[i][j] +'" size="30" style="height:18px;" class="line"> <button type="button" value="-" class="pointer" onclick="deleteRow(this)"><img src="/admin/skin/default/images/common/icon_minus.gif" height="18px" align="middle"></button>';
								labelTableHtml += '</td></tr>';
							}
						}						
				...
				html = '<input type="text" name="windowLabelValue['+label_item_seq+']" class="windowLabelValue line" label_item_seq="'+label_item_seq+'"  size="30" style="height:18px;"> <button type="button"  class="pointer" onclick="labelAdd(\'select\')"><img src="/admin/skin/default/images/design/icon_design_plus.gif" height="18px" align="middle"></button> <button type="button" class="pointer" onclick="labelSubAdd('+label_item_seq+')"><img src="/admin/skin/default/images/common/icon_plus.gif" height="18px" align="middle"></button>';
				label_item_seq++;
			}
			$("#labelTable").append(labelTableHtml);
		break;
