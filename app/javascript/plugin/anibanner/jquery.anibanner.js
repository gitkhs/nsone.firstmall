		...
		$.widget( "custom.anibanner", {
			...
			set_mobile_style_2: function(){
				...
				var set_mobile_style_2_reset = function(){
					...
					if	(!this.org_width)	this.org_width	= main_width;
					if	(!this.org_height)	this.org_height	= main_height;
					if	(!this.chk_per && this.org_width > 0 && this.org_height > 0){
						this.chk_per	= ( this.org_height / this.org_width );
					}
					if	(this.chk_per > 0 && main_width > 0 && main_height > 0){
						var chk_height	= main_width * this.chk_per;
