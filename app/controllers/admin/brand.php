...
class brand extends admin_base {
	...
	public function ifrm_brand_design(){
		...
		/* 브랜드 sort를 초기 한번만 migration해주기 위한 config 값*/
		$chkmig		= 'N';
		$migsort	= config_load('mig_sort_brand');
	...
	public function tree(){
		...
		require_once(APPPATH."/javascript/plugin/jstree/_tree/_inc/class.brand_tree.php");
		
		$jstree = new json_tree('fm_brand');
