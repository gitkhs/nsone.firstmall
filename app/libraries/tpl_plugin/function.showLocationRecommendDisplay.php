...
function showLocationRecommendDisplay($location_code)
{
	...
	if($display){
		...
		**/
		...
		if(!$CI->designDisplayTabAjaxIdx) echo "<div id='{$display_key}' class='designLocationRecommendDisplay' designElement='locationRecommendDisplay' templatePath='{$template_path}' displaySeq='{$display_seq}' perpage='{$perpage}' location='{$location_code}'>";
