...
function getCouponCode($type = null)
{
	...
	if( !($CI->managerInfo && $_GET['previewlayer'] && ($type == 'birthday' || $type == 'anniversary' || $type =='memberGroup' ) ) && $CI->userInfo['member_seq'] &&  in_array($coupons['type'],$CI->couponmodel->couponpagetype['mypage']) ) {//생일자/기념일/회원등급
