...
function escrow_mark($max_width=null,$max_height=null)
{
	...
	if($CI->config_system['pgCompany'] == 'lg'){
		...
		$result .= '<script type="text/javascript" src="https://pgweb.dacom.net/WEB_SERVER/js/escrowValid.js"></script>';
	...
	if($CI->config_system['pgCompany'] == 'kcp' ){
		$result .= '<form name="shop_check" method="post" action="https://admin.kcp.co.kr/Modules/escrow/kcp_pop.jsp" target="kcp_pop">';
