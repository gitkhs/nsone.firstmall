...
function showCategoryRecommendDisplay($category_code)
{
	...
	if($display){
		...
		**/
		...
		if(!$CI->designDisplayTabAjaxIdx) echo "<div id='{$display_key}' class='designCategoryRecommendDisplay' designElement='categoryRecommendDisplay' templatePath='{$template_path}' displaySeq='{$display_seq}' perpage='{$perpage}' category='{$category_code}'>";
