...
class CI_Profiler {
	...
	protected function _compile_queries()
	{
		...
		foreach ($dbs as $db)
		{
			...
			$hide_queries = (count($db->queries) > $this->_query_toggle_count) ? ' ' : '';
	...
	protected function _compile_memory_usage()
	{
		...
		{
			$output .= "<div style='color:#5a0099;font-weight:normal;padding:4px 0 4px 0'>".($this->convert($usage)).' </div>';
		}
		else
		{
			$output .= "<div style='color:#5a0099;font-weight:normal;padding:4px 0 4px 0'>".$this->convert($this->CI->lang->line('profiler_no_memory'))."</div>";
		}
